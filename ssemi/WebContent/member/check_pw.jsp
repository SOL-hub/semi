    ...
    <form action="check_pw.do" method="post">
        <main>
            <div class="find-wrap">
                ...
                <div class="font-find_id"><a href="find_id,pw.jsp">아이디찾기</a></div>
           ...
           <!--<input type ="hidden" name="go" value="<%=go%>">--> 
            ...
            <input class="form-find-id" type="text" name="member_phone" placeholder="비밀번호" required>
            <br>
           ...
           <!-- <select class="form-phone" name="user_phone">
            ...
            <!--비밀번호변경 버튼-->
            <input class="click-btn" type="submit" value="비밀번호 변경"> <br>
        </main>
