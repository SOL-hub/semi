	...
	<div class="img-wrap">
		<article>
			...
			<body class="Body">
				<div id="frame">
					<form>
						<div id="frame2">
							...
							<span class="home">홈>결제완료</span> <span></span>
						</div>
							...
							<table class="calculation1">
								...
								<tbody>
									<tr style="height: 90px; background-color: #fff;">
										...
										<td
											style="text-align: left; padding-left: 10px; border-left: none; font-weight: bold;">상품
											작성해주세요.</td>
                        ...
                        <input type="hidden" name="item_no" value="goodbed">-->
											...
											&nbsp;개 <!--<input type="submit" value="장바구니에 담기">-->
											</form>
										</td>
										...
										<td>
											<button class="btn default"
												style="width: 90px; padding: 10px; margin-bottom: 2.5px; font-size: 13px; background: white">상세보기</button>
											<button class="btn default"
												style="width: 90px; padding: 10px; margin-bottom: 2.5px; font-size: 13px;">주문취소</button>
						...
						<div style="margin: 10px 10;" align="left">

							<button class="btn default backBtn btnfloat2"
								style="background-color: gray; color: #fff;">내 포인트보기</button>

							<button class="btn default backBtn btnfloat2">장바구니가기</button>
						...
						<div align="center">
							<button class="btn default " id="productClear">주문/배송 조회</button>

							<button class="btn default backBtn" id="productClear">쇼핑계속하기</button>
							<br>
							<br>
							<br> <span class="clearboth"></span>
						</div>
					</form>
				...
				<h5 style="font-size: 30px;"width:1000px;>다른 고객이 함께 구매한 상품</h5>
				<hr class="hr-twolow">
				<!--제품관련 스타일-->
				<ul>
