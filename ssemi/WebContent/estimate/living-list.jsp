...
<a href="<%=request.getContextPath()%>/Living/bath-list.jsp"> 욕실</a> 
 <a href="<%=request.getContextPath()%>/Living/kit-list.jsp">주방</a>
 <a href="<%=request.getContextPath()%>/Living/living-list.jsp"> <font color=#1778ba>마루</font></a>
</div>
