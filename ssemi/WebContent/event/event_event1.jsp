         ...
         <article>
            ...
            <div style="padding-top: 100px;" align="center">
               ...
               <h1 style="font-size: 45px;">
                 여름 더우시죠? 시~원하게 쏘겠습니다.<br>선착순10명의 고객님들께만 드리는 포인트 이벤트 실시
               </h1>
             <h1 style=font-width:bold;>2020-07-21(화) 10시 START</h1>
               
              
               <br> <br> 곧 다가오는 여름. 선착순 10명의 고객님에게만 드리는 특별한 포인트!
            <br>올 여름에 사려했던 가구가 어떤 것인지와 그 이유를 적어주시면 <br>선착순으로
               내용을 달아주신 고객님께 포인트를 제공해드리는 이벤트를 진행하고 있습니다<br>적립한 포인트로 최강 혜택을 경험하세요
             </div> 
